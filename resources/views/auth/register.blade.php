...
<body>
    <div class="relative min-h-screen flex flex-1 flex-col items-center justify-center h-full">

        <img class="object-cover fixed w-full h-full -z-[1]" src="https://images.unsplash.com/photo-1550859492-d5da9d8e45f3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="">
        ...
        <h1 class="sr-only"> {{ __('Register') }} </h1>
        
        
        <form method="POST" action="{{ route('register') }}" class="w-full max-w-sm">
            @csrf
            <div class="mb-2">
                <label for="name" class="block text-sm font-semibold leading-6 text-gray-900">{{ __('Name') }}</label>
                <input 
                    id="name" 
                    type="text" 
                    ...
                    @error('name') focus:ring-red-500 @enderror" 
            ...
            <div class="mb-2">
                ...
                <input 
                    ...
                    type="email" 
                    class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200 
                    @error('email') focus:ring-red-500 @enderror" 
                    name="email" 
                    value="{{ old('email') }}" 
                    required 
                    autocomplete="email">
            ...
            <div class="mb-2">
                ...
                <input 
                    ...
                    type="password" 
                    class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200  
                    @error('password') focus:ring-red-500 @enderror" 
                    name="password" 
                    required 
            ...
            <div class="mb-2">
                <label for="password-confirm" class="block text-sm font-semibold leading-6 text-gray-900">{{ __('Confirm Password') }}</label>
