            ...
            <div class="relative flex items-center">
                ...
                <div class="relative hidden lg:flex justify-between w-full items-center">
                    ...
                    <nav class="text-sm leading-6 font-semibold text-slate-700 dark:text-slate-200 w-full">
                        <div>
                            <input type="text" class="w-full pl-14 focus:outline-none bg-transparent" placeholder="Search.. Ctrl K">
                    ...
                    <div class="flex pl-2 items-center border-l border-slate-200 gap-3 dark:border-slate-800/80">
                        ...
                        <a href="#"> 
                            <img src="https://images.unsplash.com/photo-1554629947-334ff61d85dc?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=320&h=320&q=80" width="25" height="25" class="rounded-full ml-2">
                        </a>
                    </div>
                </div>
